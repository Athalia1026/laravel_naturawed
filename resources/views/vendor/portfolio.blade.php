    ...
    <div class="min-h-screen flex bg-[#f8f9fa] font-sans text-[#1a1a1a]">
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="max-w-6xl mx-auto px-12 -mt-16 relative z-10">
                ...
                {{-- ==================== 🌿 TAMBAHAN: SEKSI TIM KREATIF VENDOR ==================== --}}
                <div class="mb-12">
                    <div class="flex items-center justify-between mb-8">
                        <h3 class="text-3xl font-serif text-[#2d3e2d]">Our Creative Team</h3>
                        <a href="{{ route('profile.edit') }}"
                    ...
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-md h-[380px] bg-gray-100 group w-full block border border-gray-100">
                        <img
                        ...
                        <div class="absolute bottom-8 left-8 right-8 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
                            <div class="max-w-2xl text-white">
                                <div class="flex items-center gap-2 mb-3 bg-[#2d4a22] text-[10px] font-bold tracking-widest uppercase py-1.5 px-4 rounded-full w-fit">
                                    <i data-lucide="users" class="w-3.5 h-3.5 text-white"></i> Studio Artisans Team
                                </div>
                                <h4 class="text-xl md:text-2xl font-serif font-medium leading-tight text-white">
