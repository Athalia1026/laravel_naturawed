@if(Auth::user()->role === 'vendor')
    {{-- ========================================== --}}
    {{-- TAMPILAN KHUSUS VENDOR (FULL DASHBOARD UI) --}}
    {{-- ========================================== --}}
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body class="bg-white font-sans text-[#1a1a1a]">
        <div class="min-h-screen flex">
            ...
            {{-- Panggil Sidebar Asli Anda --}}
            @include('layouts.vendor_sidebar')

            <main class="flex-1 flex flex-col h-screen overflow-hidden">
                {{-- Header Atas Dasbor Vendor --}}
                <header class="h-20 px-12 flex items-center justify-between shrink-0 bg-white/80 backdrop-blur-md border-b border-gray-50 z-10">
                    ...
                    <div class="flex items-center gap-8">
                        <div class="flex items-center gap-5 text-gray-500">
                            ...
                            <div class="w-10 h-10 rounded-full bg-[#2d3e2d] overflow-hidden border border-gray-100 flex items-center justify-center text-white font-bold text-sm">
